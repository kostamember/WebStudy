...
<div id="wrap" align="center">
	<h1> 게시글 상세보기 </h1>
		...
		<input type="button" value="게시글 리스트" onClick="open_win('BoardServlet?command=board_list'">
		<input type="button" value="게시글 등록" onClick="open_win('BoardServlet?command=board_write_form'">
